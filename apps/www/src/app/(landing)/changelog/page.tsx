...
export const metadata = constructMetadata({
    title: "Changelog - Lucid",
    description:
        "All the latest updates, improvements, and fixes to lucid - the privacy first open source web analytics.",
    image: "https://lucid.io/api/og/changelog",
});
            ...
            <div className="relative grid border-b border-gray-200 py-20 md:grid-cols-4">
                ...
                <div className="mx-5 flex flex-col space-y-6 md:col-span-3 md:mx-0">
                    ...
                    <p className="text-lg text-gray-500 dark:text-gray-200">
                        All the latest updates, improvements, and fixes to Lucid.
                    </p>
                </div>
                <div className="absolute bottom-2 right-0 flex items-center space-x-2">
                    ...
                    <Link
                        href="https://twitter.com/lucid_io"
