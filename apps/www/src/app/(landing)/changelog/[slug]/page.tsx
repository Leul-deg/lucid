...
export async function generateMetadata({
    ...
    return {
        ...
        openGraph: {
            ...
            type: "article",
            publishedTime,
            url: `https://lucid.io/changelog/${slug}`,
            images: [
                {
                    url: image,
                },
        ...
        <div className="mx-auto my-20 grid max-w-screen-xl md:grid-cols-4 md:px-20">
            ...
            <div className="flex flex-col space-y-8 md:col-span-3">
                ...
                <div className="mt-10 flex justify-end border-t border-gray-200 pt-5">
                    <Link
                        href={`https://github.com/lucid/lucid/edit/main/apps/www/src/content/changelog/${params.slug}.mdx`}
                        target="_blank"
