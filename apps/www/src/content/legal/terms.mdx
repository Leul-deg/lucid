...
Subject to these Terms of Service (this "Agreement"), [lucid.io](/) ("lucid", "we", "us" and/or "our") provides access to lucid's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
By signing up and using the services provided by lucid (referred to as the "Service"), you are agreeing to be bound by the following terms and conditions ("Terms of Service"). The Service is owned and operated by lucid ("Us", "We", or "Our").

## 2. Description of Service

lucid provides an open-source link management tool for modern marketing teams to create, share, and track short links ("the Product"). The Product is accessible at lucid.io and other domains and subdomains controlled by Us (collectively, "the Website").
...
If you're using a default lucid.io link, we reserve the right to reclaim the shortlink if needed, particularly if it is necessary for brand compliance, to prevent confusion among users, or to maintain the integrity and reputation of our Service.
...
Questions or comments about the Website or these Terms of Service may be directed to our support team at support@lucid.io.
