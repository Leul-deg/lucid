...
```bash
GET https://api.lucid.io/v1/insight
```
...
| apiKey    | string | API key of the website you want to fetch. You can create one it in your [dashbaord](https://lucid.io/dashboard/api-keys). |
