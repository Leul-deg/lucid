...
- **Privacy first**: We take privacy seriously, so we made sure Lucid is GDPR compliant out of the box. And if you want to customize your privacy settings, we won't judge. We'll just give you the options you need.
...
Self-hosting made easy (coming soon): Self-hosting the whole thing can be a pain. That's why we're working hard to make it easy for you to host Lucid on your own servers. Stay tuned for updates on this!

Hosted version (for free): In the meantime, you can use our hosted version of Lucid for free. You can now see your web analytics (despite having no users.)