...
export default function UpgradeEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Thank you for upgrading to Lucid {plan}!</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-center text-xl font-semibold text-black">
              Thank you for upgrading to Lucid {plan}!
            </Heading>
            ...
            <Text className="text-sm leading-6 text-black">
              My name is Beka, and I'm the founder of Lucid. I wanted to
              personally reach out to thank you for upgrading to Lucid {plan}!
            </Text>
            <Text className="text-sm leading-6 text-black">
              Your support means the world to us and helps us continue to build
              and improve Lucid.
            </Text>
            <Text className="text-sm leading-6 text-black">
            ...
            <Text className="ml-1 text-sm leading-4 text-black">
              ◆ {plan === "Plus" ? "Unlimited" : "1 Million"} page views per
              month
            </Text>
            <Text className="ml-1 text-sm leading-4 text-black">
