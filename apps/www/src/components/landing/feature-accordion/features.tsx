...
const featureList = [
    ...
    },
    {
        ...
        description: "With Lucid, you can invite your teammates to collaborate on your websites.",
        cta: (
            <a
                href="https://lucid.io/dashboard"
                target="_blank"
                rel="noreferrer"
                className="block max-w-fit rounded-full border border-stone-900 bg-stone-200 px-4 py-1.5 text-sm text-stone-950 transition-all hover:bg-white hover:text-black"
            >
                        ...
                        >
                            {featureList.map(({ key, title, icon, description, cta }) => (
                                <AccordionItem key={key} value={key}>
                                    <AccordionTrigger onClick={() => lucid.track("accordion change", {
                                        feature: key
                                    })}>
