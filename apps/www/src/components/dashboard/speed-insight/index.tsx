...
import { GetVitalsResponse } from "@lucid/types";
import { Website } from "@lucid/types/models";
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent>
                ...
                <div className=" border rounded-md flex items-center justify-between pr-6">
                    ...
                    >
                        pnpm i @lucid/tracker@latest
                    </SyntaxHighlighter>
                    <CopyToClipboard text="pnpm i @lucid/tracker@latest" />
                </div>
            </DialogContent>
        </Dialog>
    )
