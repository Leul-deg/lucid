...
import { GetInsightResponse } from "@lucid/types";
...
import { TrackClick } from "@lucid/tracker/react";
import { PLAN, Website } from "@lucid/types/models";
                    ...
                    <Tabs defaultValue={defaultValue} className="space-y-4" onValueChange={(val) => {
                            ...
                            <div className=" flex items-center justify-between">
                                <TabsList>
                                    ...
                                    <TabsTrigger
                                        ...
                                        className=" dark:data-[state=active]:text-emphasis data-[state=active]:text-emphasis"
                                        onClick={() =>
                                            lucid.track("events-tab-clicked", {
                        ...
                        <div className=" flex justify-between">
                            <div
                                ...
                                onClick={() =>
                                    lucid.track("date-picker-clicked", {
                                        websiteId: website.id,
                                    })
                                }
                            >
