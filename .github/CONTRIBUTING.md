...
We really appreciate any kind of contribution regardless of your coding skills. We believe lucid should be really easy for anyone who wants to get into contributing to open-source projects. So if this is your first-time contribution we'd love to support you in any way to get in there. Read the above instructions to get the project overview better.
...
## Setting up lucid for development
...
We really want lucid to be easy for everyone who want to contribute and use in their own development setup. We've worked hard to make sure you don't have to sign up for external services or deal with complicated Docker setups that can slow down your pc. All you need is a basic sqlite database to run lucid.
...
That's it! now you can run lucid for dev environment with
