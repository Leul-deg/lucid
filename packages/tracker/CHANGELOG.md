...
- dea4dcd: - Speed Insights: Lucid tracker now collects web vital scores.
...
- 694f5de: - now lucid uses one route to send events
  - by default it'll send to lucid domain without specifying host
  - add js docs
...
- 9c428b8: the tracker will add /api/lucid by default on custom lucid url
